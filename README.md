...
This repository includes the LaTeX source files which can be compiled to generate a pdf version of my thesis.
It is based on the TUM template provided under the following license.
